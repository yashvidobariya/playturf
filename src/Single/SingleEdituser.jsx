...
import { Admineditusers, getUserAPI } from '../service/APIrouter'
...
const SingleEdituser = () => {
    ...
    const handlesubmit = async (e) => {
        ...
        try {
            ...
            const response = await GlobalApi(`${Admineditusers}/${userId}`, 'POST', formdata, token);
